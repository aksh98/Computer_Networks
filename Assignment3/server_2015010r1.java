...
public class server_2015010r1 extends Thread
{
	static Socket sock = null;
	static ServerSocket socketServ = null;
	DataInputStream inp = null;
	public static server_2015010r1[] thread = new server_2015010r1[10];
	private PrintStream os = null;
	private int name = 0;
	public static int len = 0;
	static DataOutputStream out = null;

	public server_2015010r1(Socket sock, server_2015010r1[] thread, int index)
	{
		this.sock = sock;
		this.thread = thread;
		this.name = index;
...
//	to find out num of clients : thread.length;
	...
	public void run()
	{
		server_2015010r1[] thread = this.thread;
		try
		{	
	...
	public static void main(String[] args) throws Exception
	{
		...
		{	
			...
			//thread[i] = new server_2015010r1(soc, thread, i);
			(thread[i] = new server_2015010r1(soc, thread, i)).start();
			i = i+1; 
		}
	}
}